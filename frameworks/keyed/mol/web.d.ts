...
declare namespace $ {
    class $mol_perf_jsfb extends $mol_scroll {
        ...
        Row_id(id: any): $mol_view;
        row_selected(id: any, next?: any): boolean;
        row_title(id: any): string;
        Row_title(id: any): $$.$mol_check;
        Row_drop_icon(id: any): $mol_icon_cross;
        row_drop(id: any, event?: any): any;
        Row_drop(id: any): $mol_button_minor;
    }
}
...
declare namespace $.$$ {
    class $mol_perf_jsfb extends $.$mol_perf_jsfb {
        ...
        row_title(id: number, next?: string): string;
